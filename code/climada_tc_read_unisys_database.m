function tc_track=climada_tc_read_unisys_database(unisys_file)
...
if ~exist('tc_track_bin_file','var'),tc_track_bin_file=[];end
...
if isempty(tc_track_bin_file),tc_track_bin_file=[fP filesep fN '_bin.mat'];end

if findstr(unisys_file,'she') | findstr(unisys_file,'bsh') %findstr(unisys_file,'bsh')
...
if ~exist(tc_track_bin_file,'file')
