function res=climada_hazard_plot_contour_contour(hazard,event_i,label,caxis_range,plot_centroids,entity)
% climada plot single hazard event footprint
% NAME:
%   climada_hazard_plot_contour
% PURPOSE:
%   plot hazard event as contour on a map, works for all perils. See also
%   (much faster) climada_hazard_plot
%   RENAMED from climada_hazard_plot to climada_hazard_plot_contour
%
%   see also climada_plot_tc_footprint (works for TC only)
%   and the high-resolution version climada_hazard_plot_contour_hr
%
%   See also climada_hazard_plot_contour_nogrid (later to be merged all in one)
% CALLING SEQUENCE:
%   res=climada_hazard_plot_contour(hazard,event_i,label,caxis_range,plot_centroids,entity)
% EXAMPLE:
%   climada_hazard_plot_contour(climada_hazard_load,1); % plot first event
%   climada_hazard_plot_contour; % prompt for hazard event set, plot largest event
% INPUTS:
...
% David N. Bresch, david.bresch@gmail.com, 20170706, hint to climada_hazard_plot_contour_nogrid added
...
% David N. Bresch, david.bresch@gmail.com, 20171231, renamed to climada_hazard_plot_contour
%-

fprintf('see also climada_hazard_plot_contour_nogrid to plot exactly on centroids\n');
...
end % climada_hazard_plot_contour