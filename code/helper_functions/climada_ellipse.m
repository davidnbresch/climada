function h=climada_ellipse(ra,rb,ang,x0,y0,C,Nb)
...
%  y=radm*cos(the)*si+co*radn*sin(the)+ypos;
  ...
  h(k) = area(radm*cos(the)*co-si*radn*sin(the)+xpos,radm*cos(the)*si+co*radn*sin(the)+ypos);
  set(h(k),'facecolor',C(rem(k-1,size(C,1))+1,:),'edgecolor','none');
