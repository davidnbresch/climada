...
See folder docs/climada_manual.pdf to get started. Consider running compile_all_function_headers to generate a html file with all the function headers and direct links to the source code of your local installation.
