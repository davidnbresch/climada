...
% 20171026: adapted local startup for OCTAVE (Samuel Eberenz)
%
...
%% changing data directory for OCTAVE (Samuel Eberenz)
climada_global.data_dir =[climada_global.data_dir '_octave'];
